...
首先设备暴露一个 HTTP 服务，并且在局域网中加密广播自己的ip地址和设备信息，客户端拿到广播的信息后可以调用http服务（如：http://192.168.5.11/control/switch），设备完成状态更改之后，将更改结果广播出来，客户端就可以知道更改结果了，同时设备端还会向云端上报，方便其他客户端同步设备状态
